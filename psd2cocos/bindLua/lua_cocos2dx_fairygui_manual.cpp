...
#include "editor-support/fairygui/Classes/GLabel.h"
...
static int lua_cocos2dx_fairygui_addClickListener(lua_State* L)
{
	...
	if (1 == argc)
	{
		...
		ScriptHandlerMgr::getInstance()->addObjectHandler((void*)self, handler, (ScriptHandlerMgr::HandlerType)((int)ScriptHandlerMgr::HandlerType::EVENT_CUSTOM_BEGAN + fairygui::UIEventType::Click));
...
static int lua_cocos2dx_fairygui_removeClickListener(lua_State* L)
{
	...
	if (0 == argc)
	{
		...
		ScriptHandlerMgr::getInstance()->removeObjectHandler((void*)self, (ScriptHandlerMgr::HandlerType)((int)ScriptHandlerMgr::HandlerType::EVENT_CUSTOM_BEGAN + fairygui::UIEventType::Click));
...
static int lua_cocos2dx_fairygui_addEventListener(lua_State* L)
{
	...
	if (2 == argc)
	{
		...
		//ScriptHandlerMgr::getInstance()->addCustomHandler((void*)self, handler);
		ScriptHandlerMgr::getInstance()->forceAddObjectHandler((void*)self, handler, (ScriptHandlerMgr::HandlerType)((int)ScriptHandlerMgr::HandlerType::EVENT_CUSTOM_BEGAN + eventType));
...
static int lua_cocos2dx_fairygui_removeEventListener(lua_State* L)
{
	...
	if (1 == argc)
	{
		...
		ScriptHandlerMgr::getInstance()->removeObjectHandler((void*)self, (ScriptHandlerMgr::HandlerType)((int)ScriptHandlerMgr::HandlerType::EVENT_CUSTOM_BEGAN + eventType));
...
static int lua_cocos2dx_fairygui_play(lua_State* L)
{
	...
	if (1 == argc)
	{
		...
		//ScriptHandlerMgr::getInstance()->addCustomHandler((void*)self, handler);
		ScriptHandlerMgr::getInstance()->addObjectHandler((void*)self, handler, (ScriptHandlerMgr::HandlerType)((int)ScriptHandlerMgr::HandlerType::EVENT_CUSTOM_BEGAN + fairygui::UIEventType::actionEffect));
...
static int lua_cocos2dx_fairygui_GList_setItemRenderer(lua_State* L)
{
	...
	if (1 == argc)
	{
		...
		//ScriptHandlerMgr::getInstance()->addCustomHandler((void*)self, handler);
		ScriptHandlerMgr::getInstance()->addObjectHandler((void*)self, handler, (ScriptHandlerMgr::HandlerType)((int)ScriptHandlerMgr::HandlerType::EVENT_CUSTOM_BEGAN + fairygui::UIEventType::ListRender));
