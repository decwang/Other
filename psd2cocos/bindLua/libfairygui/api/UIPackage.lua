...
--------------------------------
-- 
-- @function [parent=#UIPackage] getPixelHitTestData 
-- @param self
-- @param #string itemId
-- @return PixelHitTestData#PixelHitTestData ret (return value: fgui.PixelHitTestData)
...
-- @function [parent=#UIPackage] loadItem
-- @param self
